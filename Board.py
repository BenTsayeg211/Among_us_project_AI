...
class Board:
    ...
    def set_observation(self, agent, key,
                        value):  # TODO: AFTER EVERY ROUND UPDATE ALL AGENTS WITH WHO DIED AND WHO VOTED WHO AND SO ON
        self.__agent_observations[agent][key] = value

    def set_observations(self, agent,
                         observations):  # TODO: AFTER EVERY ROUND UPDATE ALL AGENTS WITH WHO DIED AND WHO VOTED WHO AND SO ON
